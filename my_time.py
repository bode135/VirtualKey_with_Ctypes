...
class VK:
    ...
    mouse_left   = ms_l = vk_lbutton = VK_LBUTTON = 1
    mouse_right  = ms_r = vk_rbutton = VK_RBUTTON = 2
    mouse_middle = ms_m = vk_mbutton = VK_MBUTTON = 4

    cancel = vk_cancel = VK_CANCEL = 3

    vk_xbutton1 = VK_XBUTTON1 = 5       # mouse_4
    vk_xbutton2 = VK_XBUTTON2 = 6       # mouse_5
